...
// دالة التحقق من صحة بيانات السلة
...
exports.checkout = asyncHandler(async (req, res) => {
    ...
    if(data.paymentMethod === 'credit_card') {
        ...
        const shippingCompanies = await Auth.find({ role: 'Shipping-company' }).select('username email number');
        ...
        const shippingCompany = shippingCompanies[randomIndex];
        order.ShippingCompany = shippingCompany._id;
        ...
        const mailOptions = {
            ...
            subject: 'New Order',
            text: `New order from ${req.user.username} with address ${data.address} and payment method ${data.paymentMethod}`,
        };
